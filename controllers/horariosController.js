...
const getHorarios = async (req, res) => {
    try {
        ...
        res.status(200).json({ segunda, terca, quarta, quinta, sexta, sabado, domingo });
...
const updateHorarios = async (req, res) => {
    try {
        ...
        // Retornar apenas os dias da semana, sem metadados do MongoDB
        const { segunda: seg, terca: ter, quarta: qua, quinta: qui, sexta: sex, sabado: sab, domingo: dom } = horarios;
        res.status(200).json({ segunda: seg, terca: ter, quarta: qua, quinta: qui, sexta: sex, sabado: sab, domingo: dom });
